...
const AddBook = () => {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center md:justify-start lg:justify-center p-0 md:p-6">
      <ToastContainer
      ...
      <div className="w-full max-w-md md:max-w-lg lg:max-w-full ml-14">
